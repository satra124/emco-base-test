...
func NewRouter(testClient interface{}) *mux.Router {
	...
	router.HandleFunc("/cluster-providers/{clusterProvider}", clusterHandler.putClusterProviderHandler).Methods("PUT")
	router.HandleFunc("/cluster-providers/{clusterProvider}", clusterHandler.getClusterProviderHandler).Methods("GET")
	router.HandleFunc("/cluster-providers/{clusterProvider}", clusterHandler.deleteClusterProviderHandler).Methods("DELETE")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters", clusterHandler.createClusterHandler).Methods("POST")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters", clusterHandler.getClusterHandler).Methods("GET")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters", clusterHandler.getClusterHandler).Queries("label", "{label}")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters", clusterHandler.getClusterHandler).Queries("withLabels", "{withLabels}")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters/{cluster}", clusterHandler.getClusterHandler).Methods("GET")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters/{cluster}", clusterHandler.deleteClusterHandler).Methods("DELETE")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters/{cluster}/labels", clusterHandler.createClusterLabelHandler).Methods("POST")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters/{cluster}/labels", clusterHandler.getClusterLabelHandler).Methods("GET")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters/{cluster}/labels/{clusterLabel}", clusterHandler.putClusterLabelHandler).Methods("PUT")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters/{cluster}/labels/{clusterLabel}", clusterHandler.getClusterLabelHandler).Methods("GET")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters/{cluster}/labels/{clusterLabel}", clusterHandler.deleteClusterLabelHandler).Methods("DELETE")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters/{cluster}/kv-pairs", clusterHandler.createClusterKvPairsHandler).Methods("POST")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters/{cluster}/kv-pairs", clusterHandler.getClusterKvPairsHandler).Methods("GET")
	router.HandleFunc("/cluster-providers/{clusterProvider}/clusters/{cluster}/kv-pairs/{clusterKv}", clusterHandler.putClusterKvPairsHandler).Methods("PUT")
