...
func (_m *SfcManager) CreateSfcClientIntent(sfc model.SfcClientIntent, pr string, ca string, caver string, dig string, exists bool) (model.SfcClientIntent, error) {
...
func (_m *SfcManager) DeleteSfcClientIntent(name string, pr string, ca string, caver string, dig string) error {
...
func (_m *SfcManager) GetAllSfcClientIntents(pr string, ca string, caver string, dig string) ([]model.SfcClientIntent, error) {
...
func (_m *SfcManager) GetSfcClientIntent(name string, pr string, ca string, caver string, dig string) (model.SfcClientIntent, error) {
	ret := _m.Called(name, pr, ca, caver, dig)
