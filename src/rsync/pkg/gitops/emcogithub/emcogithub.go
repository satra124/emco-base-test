...
func NewGithub(cid, app, cluster, url, branch, user, repo, token string) (*Github, error) {
...
func (p *Github) CommitFiles(commitMessage string, files interface{}) error {
