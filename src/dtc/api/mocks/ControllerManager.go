...
func (_m *ControllerManager) CreateController(ctx context.Context, ms controller.Controller, mayExist bool) (controller.Controller, error) {
	ret := _m.Called(ctx, ms, mayExist)
...
func (_m *ControllerManager) DeleteController(ctx context.Context, name string) error {
...
func (_m *ControllerManager) GetController(ctx context.Context, name string) (controller.Controller, error) {
	ret := _m.Called(ctx, name)
...
func (_m *ControllerManager) GetControllers(ctx context.Context) ([]controller.Controller, error) {
	ret := _m.Called(ctx)
...
func (_m *ControllerManager) InitControllers(ctx context.Context) {
	_m.Called(ctx)
}
