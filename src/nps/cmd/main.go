...
import (
	...
	register "gitlab.com/project-emco/core/emco-base/src/nps/pkg/grpc"
	"gitlab.com/project-emco/core/emco-base/src/nps/pkg/grpc/contextupdateserver"
...
func startGrpcServer() error {
	...
	log.Println("Starting Network Policy Controller gRPC Server")
