...
import (
	...
	"gitlab.com/project-emco/core/emco-base/src/tac/pkg/metrics"
)
...
func main() {
	...
	grpcServer, err := register.NewGrpcServer("tac", "TAC_NAME", 9065,
