...
function usage {
    echo "Usage: $0  create | create npn |cleanup"
    echo "     create:      creates chain functions with provider network interface annotations"
    echo "     create npn:  creates chain functions without provider network interface annotations"
