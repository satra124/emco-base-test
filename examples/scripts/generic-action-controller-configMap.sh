...
# define the resource
resource_name="resourceConfigMap"
...
customization_name="customizeConfigMap"
...
function createGenericActionData {
   ...
   call_api -H "Content-Type: multipart/form-data" -F "metadata=$customization_data" -F "files=@$customization_data_file" -F "files=@$customization_data_file2" \
