...
class TestCase_deleteResourceIntentGenericControllerIntent:
    def test_deleteResourceIntentGenericControllerIntent(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.delete_resource_intent_generic_controller_intent(
                        orchestrator_url, params_from_inputfile.get_anchor(0)
                    )
                    logfile.log_debug(
                        "Received Response Code: " + str(response.status_code)
                    )
                    self.delete_resource_intent_generic_controller_intent_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def delete_resource_intent_generic_controller_intent(
    ...
    @classmethod
    def delete_resource_intent_generic_controller_intent_assertion_check(
