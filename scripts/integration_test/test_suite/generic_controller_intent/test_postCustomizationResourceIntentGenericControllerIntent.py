...
class TestCase_postCustomizationResourceIntentGenericControllerIntent:
    def test_postCustomizationResourceIntentGenericControllerIntent(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_customization_resource_intent_generic_controller_intent(
                        gac_url,
                    ...
                    self.post_customization_resource_intent_generic_controller_intent_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_customization_resource_intent_generic_controller_intent(
    ...
    @classmethod
    def post_customization_resource_intent_generic_controller_intent_assertion_check(
