...
class TestCase_postClmControllers:
    def test_postClmControllers(self, cwd, clm_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_clm_controller(
                        clm_url,
                    ...
                    self.post_clm_controller_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_clm_controller(self, clm_url, anchor, request_body=None):
    ...
    @classmethod
    def post_clm_controller_assertion_check(
