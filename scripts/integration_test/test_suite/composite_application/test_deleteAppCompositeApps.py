...
class TestCase_deleteappcompositeApps:
    def test_deletecompositeApps(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.delete_app_composite_apps(
                    ...
                    self.delete_app_composite_apps_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def delete_app_composite_apps(self, orchestrator_url, anchor):
        headers = {"accept": "*/*"}
        response = requests.delete(orchestrator_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_app_composite_apps_assertion_check(
