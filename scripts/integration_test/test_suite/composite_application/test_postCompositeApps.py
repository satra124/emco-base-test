...
class TestCase_postcompositeApps:
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_composite_apps(
                        orchestrator_url,
                    ...
                    self.post_composite_apps_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_composite_apps(self, orchestrator_url, anchor, requestbody=None):
    ...
    @classmethod
    def post_composite_apps_assertion_check(
