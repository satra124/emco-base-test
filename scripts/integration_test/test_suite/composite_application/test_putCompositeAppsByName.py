...
class TestCase_putCompositeAppByName:
    def test_putComposoiteApp(self, cwd, orchestrator_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_compositeapp(
                        orchestrator_url,
                    ...
                    self.put_compositeapp_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_compositeapp(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_compositeapp_assertion_check(
