...
class TestCase_deletecompositeApps:
    ...
    @classmethod
    def delete_composite_apps(self, orchestrator_url, anchor=None):
        headers = {"accept": "*/*"}
        response = requests.delete(orchestrator_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_composite_apps_assertion_check(
