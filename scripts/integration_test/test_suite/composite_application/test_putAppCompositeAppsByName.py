...
class TestCase_putAppCompositeAppByName:
    def test_putAppComposoiteApp(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_appcompositeapp(
                        orchestrator_url,
                    ...
                    self.put_appcompositeapp_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_appcompositeapp(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_appcompositeapp_assertion_check(
