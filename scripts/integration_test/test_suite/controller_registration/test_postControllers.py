...
class TestCase_postControllers:
    def test_postControllers(self, cwd, orchestrator_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    ...
                    self.post_controller_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_controller(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def post_controller_assertion_check(
