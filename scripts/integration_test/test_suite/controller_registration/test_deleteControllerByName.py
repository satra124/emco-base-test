...
class TestCase_delController:
    def test_deleteControllersByName(
    ...
    @classmethod
    def delete_controller_by_name(self, orchestrator_url, anchor):
        headers = {"accept": "*/* "}
        response = requests.delete(orchestrator_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_controller_by_name_assertion_check(
