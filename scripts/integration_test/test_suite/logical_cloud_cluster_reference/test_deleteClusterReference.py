...
class TestCase_deleteClusterReference:
    def test_deleteClusterReference(self, cwd, dcm_url, emcotestlogging, api_input):
        try:
    ...
    @classmethod
    def delete_cluster_reference(self, dcm_url, anchor):
        headers = {"accept": "*/*"}
        response = requests.delete(dcm_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_cluster_reference_assertion_check(
