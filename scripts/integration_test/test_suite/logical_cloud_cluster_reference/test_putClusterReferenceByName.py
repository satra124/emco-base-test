...
class TestCase_putClusterReferenceByName:
    def test_putClusterReferenceByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_clusterReferenceByName(
                        orchestrator_url,
                    ...
                    self.put_clusterReferenceByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_clusterReferenceByName(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_clusterReferenceByName_assertion_check(
