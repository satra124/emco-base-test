...
class TestCase_terminateLogicalClouds:
    def test_terminateLogicalClouds(self, cwd, dcm_url, emcotestlogging, api_input):
        try:
    ...
    @classmethod
    def terminate_logical_clouds(self, dcm_url, anchor):
        headers = {"Content-Type": "application/json", "accept": "application/json"}
        response = requests.post(dcm_url + anchor, headers=headers)
        return response

    @classmethod
    def terminate_logical_clouds_assertion_check(
