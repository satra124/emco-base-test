...
class TestCase_putLogicalCloudsByName:
    def test_putLogicalCloudsByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_logicalCloudsByName(
                        orchestrator_url,
                    ...
                    self.put_logicalCloudsByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_logicalCloudsByName(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_logicalCloudsByName_assertion_check(
