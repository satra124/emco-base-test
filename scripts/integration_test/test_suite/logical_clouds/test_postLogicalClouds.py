...
class TestCase_postLogicalClouds:
    def test_postLogicalClouds(self, cwd, dcm_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_logical_clouds(
                        dcm_url,
                    ...
                    self.post_logical_clouds_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_logical_clouds(self, dcm_url, anchor, requestbody=None):
    ...
    @classmethod
    def post_logical_clouds_assertion_check(
