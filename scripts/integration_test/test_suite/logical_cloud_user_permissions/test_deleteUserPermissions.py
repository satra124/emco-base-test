...
class TestCase_deleteUserPermissions:
    def test_deleteUserPermissions(self, cwd, dcm_url, emcotestlogging, api_input):
        try:
    ...
    @classmethod
    def delete_user_permissions(self, dcm_url, anchor):
        headers = {"accept": "*/*"}
        response = requests.delete(dcm_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_user_permissions_assertion_check(
