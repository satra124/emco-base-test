...
class TestCase_putUserPermissionsByName:
    def test_putUserPermissionsByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_userPermissionsByName(
                        orchestrator_url,
                    ...
                    self.put_userPermissionsByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_userPermissionsByName(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_userPermissionsByName_assertion_check(
