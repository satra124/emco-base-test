...
class TestCase_putClusterQuotasByName:
    def test_putClusterQuotasByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_clusterQuotasByName(
                        orchestrator_url,
                    ...
                    self.put_clusterQuotasByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_clusterQuotasByName(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_clusterQuotasByName_assertion_check(
