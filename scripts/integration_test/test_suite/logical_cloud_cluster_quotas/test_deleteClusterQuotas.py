...
class TestCase_deleteClusterQuotas:
    def test_deleteClusterQuotas(self, cwd, dcm_url, emcotestlogging, api_input):
        try:
    ...
    @classmethod
    def delete_cluster_quotas(self, dcm_url, anchor):
        headers = {"accept": "*/*"}
        response = requests.delete(dcm_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_cluster_quotas_assertion_check(
