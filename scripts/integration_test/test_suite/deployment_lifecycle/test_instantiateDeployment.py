...
class TestCase_instantiateDeployment:
    def test_instantiateDeployment(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_instantiateDeployment(
                    ...
                    self.post_instantiate_deployment_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_instantiateDeployment(self, orchestrator_url, anchor):
        headers = {"Content-Type": "application/json", "accept": "application/json"}
        response = requests.post(orchestrator_url + anchor, headers=headers)
        return response

    @classmethod
    def post_instantiate_deployment_assertion_check(
