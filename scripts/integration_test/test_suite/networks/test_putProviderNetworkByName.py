...
class TestCase_putProviderNetworkByName:
    def test_putProviderNetworkByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_providerNetworkByName(
                        orchestrator_url,
                    ...
                    self.put_providerNetworkByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_providerNetworkByName(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_providerNetworkByName_assertion_check(
