...
class TestCase_postProviderNetwork:
    def test_postProviderNetwork(self, cwd, ncm_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_provider_network(
                        ncm_url,
                    ...
                    self.post_provider_network_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_provider_network(self, ncm_url, anchor, request_body=None):
    ...
    @classmethod
    def post_provider_network_assertion_check(
