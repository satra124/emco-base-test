...
class TestCase_applyNetwork:
    def test_applytNetwork(self, cwd, ncm_url, emcotestlogging, api_input):
        try:
    ...
    @classmethod
    def post_apply_network(self, ncm_url, anchor):
    ...
    @classmethod
    def post_apply_network_assertion_check(self, logfile, response, responseCode=None):
