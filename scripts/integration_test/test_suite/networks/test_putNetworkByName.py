...
class TestCase_putNetworkByName:
    def test_putNetworkByName(self, cwd, orchestrator_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_networkByName(
                        orchestrator_url,
                    ...
                    self.put_networkByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_networkByName(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_networkByName_assertion_check(
