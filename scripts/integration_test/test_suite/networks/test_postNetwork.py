...
class TestCase_postNetwork:
    def test_postNetwork(self, cwd, ncm_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    ...
                    self.post_network_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_network(self, ncm_url, anchor, responseBody=None):
    ...
    @classmethod
    def post_network_assertion_check(
