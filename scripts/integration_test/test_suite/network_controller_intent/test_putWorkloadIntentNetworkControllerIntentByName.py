...
class TestCase_putWorkloadIntentNetworkControllerIntentByName:
    def test_putWorkloadIntentNetworkControllerIntentByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_workloadIntentNetworkControllerIntentByName(
                        orchestrator_url,
                    ...
                    self.put_workloadIntentNetworkControllerIntentByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_workloadIntentNetworkControllerIntentByName(
        self, orchestrator_url, anchor, request_body=None
    ):
    ...
    @classmethod
    def put_workloadIntentNetworkControllerIntentByName_assertion_check(
