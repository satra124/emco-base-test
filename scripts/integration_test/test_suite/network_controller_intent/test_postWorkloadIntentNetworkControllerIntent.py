...
class TestCase_postWorkloadIntentNetworkControllerIntent:
    def test_postWorkloadIntentNetworkControllerIntent(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_workload_intent_network_controller_intent(
                        orchestrator_url,
                    ...
                    self.post_workload_intent_network_controller_intent_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_workload_intent_network_controller_intent(
    ...
    @classmethod
    def post_workload_intent_network_controller_intent_assertion_check(
