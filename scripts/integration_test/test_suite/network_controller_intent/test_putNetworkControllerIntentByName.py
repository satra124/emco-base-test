...
class TestCase_putNetworkControllerIntentByName:
    def test_putNetworkControllerIntentByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_networkControllerIntentByName(
                        orchestrator_url,
                    ...
                    self.put_networkControllerIntentByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_networkControllerIntentByName(
    ...
    @classmethod
    def put_networkControllerIntentByName_assertion_check(
