...
class TestCase_postNetworkControllerIntent:
    def test_postNetworkControllerIntent(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_network_controller_intent(
                        orchestrator_url,
                    ...
                    self.post_network_controller_intent_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_network_controller_intent(
    ...
    @classmethod
    def post_network_controller_intent_assertion_check(
