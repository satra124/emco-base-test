...
class TestCase_getWorkloadInterfacesNetworkControllerIntent:
    def test_getWorkloadInterfacesNetworkControllerIntent(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.get_workload_interfaces__network_controller_intent(
                    ...
                    self.get_workload_interfaces__network_controller_intent_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def get_workload_interfaces__network_controller_intent(
    ...
    @classmethod
    def get_workload_interfaces__network_controller_intent_assertion_check(
