...
class TestCase_postIntentGenericPlacementIntent:
    def test_postIntentGenericPlacementIntent(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_intent_generic_placement_intent(
                        orchestrator_url,
                    ...
                    self.post_intent_generic_placement_intent_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_intent_generic_placement_intent(
    ...
    @classmethod
    def post_intent_generic_placement_intent_assertion_check(
