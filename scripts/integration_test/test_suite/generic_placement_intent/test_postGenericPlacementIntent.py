...
class TestCase_postGenericPlacementIntent:
    def test_postGenericPlacementIntent(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_generic_placement_intent(
                        orchestrator_url,
                    ...
                    self.post_generic_placement_intent_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_generic_placement_intent(self, orchestrator_url, anchor, requestbody=None):
    ...
    @classmethod
    def post_generic_placement_intent_assertion_check(
