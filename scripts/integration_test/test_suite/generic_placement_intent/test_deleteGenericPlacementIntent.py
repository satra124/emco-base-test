...
class TestCase_deleteGenericPlacementIntent:
    def test_deleteGenericPlacementIntent(
    ...
    @classmethod
    def delete_generic_placement_intent(self, orchestrator_url, anchor):
        headers = {"accept": "*/*"}
        response = requests.delete(orchestrator_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_generic_placement_intent_assertion_check(
