...
class TestCase_putIntentGenericPlacementIntentByName:
    def test_putIntentGenericPlacementIntentByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_genericPlacementIntentByName(
                        orchestrator_url,
                    ...
                    self.put_genericPlacementIntentByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_intentGenericPlacementIntentByName(
    ...
    @classmethod
    def put_intentGenericPlacementIntentByName_assertion_check(
