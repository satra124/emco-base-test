...
class TestCase_putGenericPlacementIntent:
    def test_putGenericPlacementIntentByName(
    ...
    @classmethod
    def put_genericPlacementIntentByName(
    ...
    @classmethod
    def put_genericPlacementIntentByName_assertion_check(
