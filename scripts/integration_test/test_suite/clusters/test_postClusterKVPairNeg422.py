...
class TestCase_postclusterKVPair:
    def test_postclusterKVPAir(self, cwd, clm_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_clusterKVPair(
                        clm_url,
                    ...
                    self.post_cluster_kvpair_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_clusterKVPair(self, clm_url, anchor, requestbody=None):
    ...
    @classmethod
    def post_cluster_kvpair_assertion_check(
