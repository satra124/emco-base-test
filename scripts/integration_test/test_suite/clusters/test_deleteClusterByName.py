...
class TestCase_delCluster:
    def test_delCluster(self, cwd, clm_url, emcotestlogging, api_input):
        try:
    ...
    @classmethod
    def delete_cluster_by_name(self, clm_url, anchor):
        headers = {"accept": "*/* "}
    ...
    @classmethod
    def delete_cluster_by_name_assertion_check(
