...
class TestCase_putClusterLabels:
    def test_putClusterLabelsByName(self, cwd, clm_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_clustersLabels(
                        clm_url,
                    ...
                    self.put_clustersLabels_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_clustersLabels(self, clm_url, anchor, requestbody=None):
    ...
    @classmethod
    def put_clustersLabels_assertion_check(
