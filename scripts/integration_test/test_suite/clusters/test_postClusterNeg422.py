...
class TestCase_postcluster:
    def test_postcluster(self, cwd, clm_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    ...
                    self.post_cluster_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_cluster(self, clm_url, anchor, requestbody=None, files=None):
        headers = {}
    ...
    @classmethod
    def post_cluster_assertion_check(
