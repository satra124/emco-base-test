...
class TestCase_delClusterKVPair:
    def test_delClusterKVPair(self, cwd, clm_url, emcotestlogging, api_input):
        try:
    ...
    @classmethod
    def delete_cluster_kvpair_by_name(self, clm_url, anchor):
        headers = {"accept": "*/* "}
        response = requests.delete(clm_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_cluster_kvpair_assertion_check(
