...
class TestCase_postclusterlabel:
    def test_postclusterlabel(self, cwd, clm_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_cluster_label(
                        clm_url,
                    ...
                    self.post_cluster_label_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_cluster_label(self, clm_url, anchor, requestbody=None):
    ...
    @classmethod
    def post_cluster_label_assertion_check(
