...
class TestCase_deleteKVPairs:
    def test_deleteKVPairs(self, cwd, dcm_url, emcotestlogging, api_input):
        try:
    ...
    @classmethod
    def delete_kv_pairs(self, dcm_url, anchor):
        headers = {"accept": "*/*"}
        response = requests.delete(dcm_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_kv_pairs_assertion_check(self, logfile, response, responseCode=None):
