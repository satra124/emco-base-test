...
class TestCase_putKVPairsByName:
    def test_putKVPairsByName(self, cwd, orchestrator_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_KVPairsByName(
                        orchestrator_url,
                    ...
                    self.put_KVPairsByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_KVPairsByName(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_KVPairsByName_assertion_check(
