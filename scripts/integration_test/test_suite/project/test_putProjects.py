...
class TestCase_putProj:
    def test_putProjects(self, cwd, orchestrator_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    ...
                    self.put_projects_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_projects(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_projects_assertion_check(
