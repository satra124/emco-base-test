...
class TestCase_deleteDeploymentIntentGroup:
    def test_deleteDeploymentIntentGroup(
    ...
    @classmethod
    def delete_deployment_intent_group(self, orchestrator_url, anchor):
        headers = {"accept": "*/*"}
        response = requests.delete(orchestrator_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_deployment_intent_group_assertion_check(
