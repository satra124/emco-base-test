...
class TestCase_postIntentDeploymentIntentGroup:
    def test_postIntentDeploymentIntentGroup(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_intent_deployment_intent_group(
                        orchestrator_url,
                    ...
                    self.post_intent_deployment_intent_group_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_intent_deployment_intent_group(
    ...
    @classmethod
    def post_intent_deployment_intent_group_assertion_check(
