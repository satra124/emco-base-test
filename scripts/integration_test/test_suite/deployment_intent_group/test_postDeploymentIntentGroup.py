...
class TestCase_postDeploymentIntentGroup:
    def test_postDeploymentIntentGroup(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_deployment_intent_group(
                        orchestrator_url,
                    ...
                    self.post_deployment_intent_group_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_deployment_intent_group(self, orchestrator_url, anchor, requestbody=None):
    ...
    @classmethod
    def post_deployment_intent_group_assertion_check(
