...
class TestCase_putDeploymentIntentGroupByName:
    def test_putDeploymentIntentGroupByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_deploymentIntentGroupByName(
                        orchestrator_url,
                    ...
                    self.put_deploymentIntentGroupByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_deploymentIntentGroupByName(
    ...
    @classmethod
    def put_deploymentIntentGroupByName_assertion_check(
