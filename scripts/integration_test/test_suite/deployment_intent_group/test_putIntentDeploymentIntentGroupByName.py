...
class TestCase_putIntentDeploymentIntentGroupByName:
    def test_putIntentDeploymentIntentGroupByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_intentDeploymentIntentGroupByName(
                        orchestrator_url,
                    ...
                    self.put_intentDeploymentIntentGroupByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_intentDeploymentIntentGroupByName(
    ...
    @classmethod
    def put_intentDeploymentIntentGroupByName_assertion_check(
