...
class TestCase_putResourceHPAIntentByName:
    def test_putResourceHPAIntentByName(self, cwd, hpa_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_resource_hpa_intent_by_name(
                        hpa_url,
                    ...
                    self.put_resource_hpa_intent_by_name_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_resource_hpa_intent_by_name(self, hpa_url, anchor, request_body=None):
    ...
    @classmethod
    def put_resource_hpa_intent_by_name_assertion_check(
