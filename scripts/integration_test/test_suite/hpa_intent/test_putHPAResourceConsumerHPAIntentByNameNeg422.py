...
class TestCase_putHPAResourceConsumerHPAIntentByName:
    def test_putHPAResourceConsumerHPAIntentByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_hpa_resource_consumer_hpa_intent_by_name(
                        hpa_url,
                    ...
                    self.put_hpa_resource_consumer_hpa_intent_by_name_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_hpa_resource_consumer_hpa_intent_by_name(
        self, hpa_url, anchor, request_body=None
    ):
        headers = {"Content-Type": "application/json", "accept": "application/json"}
        payload = request_body
        response = requests.put(hpa_url + anchor, data=payload, headers=headers)
        return response

    @classmethod
    def put_hpa_resource_consumer_hpa_intent_by_name_assertion_check(
