...
class TestCase_deleteResourceHPAIntent:
    def test_deleteResourceHPAIntent(self, cwd, hpa_url, emcotestlogging, api_input):
        try:
    ...
    @classmethod
    def delete_resource_hpa_intent(self, hpa_url, anchor):
        headers = {"accept": "*/*"}
        response = requests.delete(hpa_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_resource_hpa_intent_assertion_check(
