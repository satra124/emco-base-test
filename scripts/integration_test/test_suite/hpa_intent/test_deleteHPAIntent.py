...
class TestCase_deleteHPAIntent:
    def test_deleteHPAIntent(self, cwd, hpa_url, emcotestlogging, api_input):
        try:
    ...
    @classmethod
    def delete_hpa_intent(self, hpa_url, anchor):
        headers = {"accept": "*/*"}
        response = requests.delete(hpa_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_hpa_intent_assertion_check(self, logfile, response, responseCode=None):
