...
class TestCase_postResourceHPAIntent:
    def test_postResourceHPAIntent(self, cwd, hpa_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_resource_hpa_intent(
                        hpa_url,
                    ...
                    self.post_resource_hpa_intent_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_resource_hpa_intent(self, hpa_url, anchor, requestbody=None):
    ...
    @classmethod
    def post_resource_hpa_intent_assertion_check(
