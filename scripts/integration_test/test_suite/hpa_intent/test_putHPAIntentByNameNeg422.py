...
class TestCase_putHPAIntentByName:
    def test_putHPAIntentByName(self, cwd, hpa_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_HPAIntentByName(
                        hpa_url,
                    ...
                    self.put_HPAIntentByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_HPAIntentByName(self, hpa_url, anchor, request_body=None):
    ...
    @classmethod
    def put_HPAIntentByName_assertion_check(
