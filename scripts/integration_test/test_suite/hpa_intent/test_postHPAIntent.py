...
class TestCase_postHPAIntent:
    def test_postHPAIntent(self, cwd, hpa_url, emcotestlogging, api_input):
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    ...
                    self.post_hpa_intent_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_hpa_intent(self, hpa_url, anchor, requestbody=None):
    ...
    @classmethod
    def post_hpa_intent_assertion_check(
