...
class TestCase_queryProfileForApp:
    def test_queryProfileForApp(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    ...
                    response = self.query_profile_for_app(
                    ...
                    self.query_profile_for_app_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def query_profile_for_app(self, orchestrator_url, anchor):
        headers = {"accept": "application/json"}
        response = requests.get(orchestrator_url + anchor, headers=headers)
        return response

    @classmethod
    def query_profile_for_app_assertion_check(
