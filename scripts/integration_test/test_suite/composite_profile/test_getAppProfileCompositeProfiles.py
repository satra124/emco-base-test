...
class TestCase_getAppProfilecompositeProfile:
    def test_getAppProfilecompositeProfile(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    ...
                    response = self.get_app_profile_composite_profile(
                    ...
                    self.get_app_profile_composite_profile_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def get_app_profile_composite_profile(self, orchestrator_url, anchor):
        headers = {}
        response = requests.get(orchestrator_url + anchor, headers=headers)
        return response

    @classmethod
    def get_app_profile_composite_profile_assertion_check(
