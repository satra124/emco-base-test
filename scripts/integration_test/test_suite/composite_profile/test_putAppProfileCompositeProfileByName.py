...
class TestCase_putAppProfileCompositeProfileByName:
    def test_putAppProfileCompositeProfileByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    ...
                    self.put_appProfileCompositeProfile_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_appProfile(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_appProfileCompositeProfile_assertion_check(
