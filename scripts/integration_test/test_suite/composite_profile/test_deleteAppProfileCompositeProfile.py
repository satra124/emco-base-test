...
class TestCase_deleteappprofilecompositeProfile:
    def test_deleteappprofilecompositeProfile(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.delete_app_profile_composite_profile(
                    ...
                    self.delete_app_profile_composite_profile_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def delete_app_profile_composite_profile(self, orchestrator_url, anchor):
        headers = {"accept": "*/*"}
        response = requests.delete(orchestrator_url + anchor, headers=headers)
        return response

    @classmethod
    def delete_app_profile_composite_profile_assertion_check(
