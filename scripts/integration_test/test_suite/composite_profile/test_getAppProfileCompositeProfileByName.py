...
class TestCase_getAppProfilecompositeProfileByName:
    def test_getAppProfilecompositeProfileByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    ...
                    response = self.get_app_profile_composite_profile_by_name(
                    ...
                    self.get_app_profile_composite_profile_by_name_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def get_app_profile_composite_profile_by_name(self, orchestrator_url, anchor):
        headers = {"accept": "application/json"}
        response = requests.get(orchestrator_url + anchor, headers=headers)
        return response

    @classmethod
    def get_app_profile_composite_profile_by_name_assertion_check(
