...
class TestCase_putCompositeProfileByName:
    def test_putCompositeProfileByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_CompositeProfile(
                        orchestrator_url,
                    ...
                    self.put_CompositeProfile_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_CompositeProfile(self, orchestrator_url, anchor, request_body=None):
    ...
    @classmethod
    def put_CompositeProfile_assertion_check(
