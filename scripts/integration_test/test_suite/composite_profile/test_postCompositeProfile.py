...
class TestCase_postcompositeprofile:
    def test_postcompositeprofile(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_composite_profile(
                        orchestrator_url,
                    ...
                    self.post_composite_profile_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_composite_profile(self, orchestrator_url, anchor, requestbody=None):
    ...
    @classmethod
    def post_composite_profile_assertion_check(
