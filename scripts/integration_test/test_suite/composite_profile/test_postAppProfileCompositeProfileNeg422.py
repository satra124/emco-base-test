...
class TestCase_postAppProfilecompositeProfile:
    def test_postAppProfilecompositeProfile(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    ...
                    response = self.post_app_profile_composite_profile(
                        orchestrator_url,
                    ...
                    self.post_app_profile_composite_profile_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_app_profile_composite_profile(
        ...
        if not os.path.exists(app_profile):
            logfile.log_debug("Error: No such file exists {0}".format(app_profile))
            sys.exit(-1)
    ...
    @classmethod
    def post_app_profile_composite_profile_assertion_check(
