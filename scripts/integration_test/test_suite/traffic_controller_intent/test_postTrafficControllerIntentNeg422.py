...
class TestCase_postTrafficControllerIntent:
    def test_postTrafficControllerIntent(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.post_traffic_controller_intent(
                        dtc_url,
                    ...
                    self.post_traffic_controller_intent_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def post_traffic_controller_intent(self, dtc_url, anchor, requestbody=None):
    ...
    @classmethod
    def post_traffic_controller_intent_assertion_check(
