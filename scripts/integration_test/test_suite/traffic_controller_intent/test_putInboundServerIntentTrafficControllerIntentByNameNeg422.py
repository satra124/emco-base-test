...
class TestCase_putInboundServerIntentTrafficControllerIntentByName:
    def test_putInboundServerIntentTrafficControllerIntentByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_inboundServerIntentTrafficControllerIntentByName(
                        dtc_url,
                    ...
                    self.put_inboundServerIntentTrafficControllerIntentByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_inboundServerIntentTrafficControllerIntentByName(
        self, dtc_url, anchor, request_body=None
    ):
        headers = {"Content-Type": "application/json", "accept": "application/json"}
        payload = request_body
        response = requests.put(dtc_url + anchor, data=payload, headers=headers)
        return response

    @classmethod
    def put_inboundServerIntentTrafficControllerIntentByName_assertion_check(
