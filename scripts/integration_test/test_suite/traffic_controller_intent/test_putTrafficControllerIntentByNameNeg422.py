...
class TestCase_putTrafficControllerIntentByName:
    def test_putTrafficControllerIntentByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_trafficControllerIntentByName(
                        dtc_url,
                    ...
                    self.put_trafficControllerIntentByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_trafficControllerIntentByName(self, dtc_url, anchor, request_body=None):
    ...
    @classmethod
    def put_trafficControllerIntentByName_assertion_check(
