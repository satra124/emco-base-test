...
class TestCase_putInboundClientIntentTrafficControllerIntentByName:
    def test_putInboundClientIntentTrafficControllerIntentByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.put_inboundClientIntentTrafficControllerIntentByName(
                        dtc_url,
                    ...
                    self.put_inboundClientIntentTrafficControllerIntentByName_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def put_inboundClientIntentTrafficControllerIntentByName(
    ...
    @classmethod
    def put_inboundClientIntentTrafficControllerIntentByName_assertion_check(
