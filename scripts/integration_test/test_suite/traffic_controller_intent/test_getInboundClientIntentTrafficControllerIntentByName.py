...
class TestCase_getInboundClientIntentTrafficControllerIntentByName:
    def test_getInboundClientIntentTrafficControllerIntentByName(
        ...
        try:
            ...
            try:
                for item in range(0, no_of_api_calls):
                    response = self.get_inbound_client_intent_traffic_controller_intent_by_name(
                    ...
                    self.get_inbound_client_intent_traffic_controller_intent_by_name_assertion_check(
                        logfile,
                        response,
    ...
    @classmethod
    def get_inbound_client_intent_traffic_controller_intent_by_name(
        self, dtc_url, anchor
    ):
    ...
    @classmethod
    def get_inbound_client_intent_traffic_controller_intent_by_name_assertion_check(
